...
def train_model(training_data, model, optimizer):
    ...
    # Callbacks
    checkpoint_path = "./training_frame1/cp-{epoch:04d}.ckpt"
    ...
    callbacks = [
        ...
        tf.keras.callbacks.TensorBoard(log_dir='./training_frame1', write_graph=False),
    ...
    with open('./training_frame1/model.json', 'w') as json_file:
